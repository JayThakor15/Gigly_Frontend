...
const Hero = () => {
	...
	return (
		<div className="relative w-full flex flex-col items-center overflow-hidden">
			...
			></video>
			<div className="absolute top-60 z-10 w-full flex flex-col items-center justify-center">
			...
			<div className="relative w-full mt-8 flex items-center justify-center">
				...
				<div className="flex gap-4 px-8">
					{visibleCategories.map((cat, idx) => (
						<CategoryBox key={idx + startIdx} icon={cat.icon} label={cat.label} />
					))}
				</div>
				{/* Right Arrow */}
				<button
			...
			<div className='p-6'>
				...
				<h1 className='relative z-10 text-5xl font-bold top-50 left-10 text-white'>Needs Expert help<span className='text-green-500'>?</span></h1>
				<p className='relative z-10 text-lg top-53 left-10 text-white'>Find the perfect freelancer to bring your project to life.</p>
				<button className="btn btn-outline relative z-10 top-60 left-10 text-white hover:bg-green-500" onClick={() => document.getElementById("my_modal_5").showModal()}>Hire Now</button>
				</div>
				<img src="/Tagline_Background.jpg" alt="" srcset="" className='w-full rounded-2xl opacity-50' />
			</div>
		</div>
	)
}
